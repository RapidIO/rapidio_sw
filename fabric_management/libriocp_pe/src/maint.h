...
int RIOCP_WU riocp_pe_maint_read_remote(struct riocp_pe *mport, uint32_t destid, uint8_t hopcount,
	uint32_t offset, uint32_t *val);
int RIOCP_WU riocp_pe_maint_read_remote_silent(struct riocp_pe *mport, uint32_t destid, uint8_t hopcount,
	uint32_t offset, uint32_t *val);
...
int RIOCP_WU riocp_pe_maint_device_add(struct riocp_pe *pe);
int RIOCP_WU riocp_pe_maint_device_del(struct riocp_pe *pe);
