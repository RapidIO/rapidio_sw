...
int RIOCP_WU riocp_pe_switch_get_counter_capabilites(struct riocp_pe *sw, uint8_t port, counter_caps_t *counter_caps);
int RIOCP_WU riocp_pe_switch_get_counters(struct riocp_pe *sw, uint8_t port, counter_regs_t *counter_regs,
